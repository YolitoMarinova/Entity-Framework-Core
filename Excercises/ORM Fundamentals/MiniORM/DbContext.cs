...
namespace MiniORM
{
    public abstract class DbContext
    {
            ...
            where TEntity : class, new()
        {
            ...
            {
                this.connection.UpdateEntities(modifiedEntites, tableName, columns);
            }
            ...
            foreach (var foreignKey in foreignKeys)
            {
                ...
                foreach (var entity in dbSet)
                {
                    ...
                    var navigationPropertyValue = ((IEnumerable<object>)navigationDbSet)
                        .First(currentNavProp => navigationPrimaryKey.GetValue(currentNavProp).Equals(foreignKeyValue));
        ...
        private static bool IsObjectValid(object e)
        {
            ...
            var validationResult = Validator
                .TryValidateObject(e, validationContext, validationErros, validateAllProperties: true);
        ...
        private string[] GetEntityColumnNames(Type table)
        {
            ...
            var columns = table
                .GetProperties()
                .Where(pi => dbColumns.Contains(pi.Name) && AllowedSqlTypes.Contains(pi.PropertyType))
                .Select(pi => pi.Name)
                .ToArray();
